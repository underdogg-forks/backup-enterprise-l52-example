            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <a class="btn btn-default btn-sm" href="{!! route('admin.permissions.create') !!}"
                       title="{{ trans('admin/permissions/general.action.create') }}">
                        <i class="fa fa-plus-square"></i>
                    </a>
                    &nbsp;
                    <a class="btn btn-default btn-sm" href="{!! route('admin.permissions.generate') !!}"
                       title="{{ trans('admin/permissions/general.action.generate') }}">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <i class="fa fa-pencil-square-o text-muted"
                                               title="{{ trans('admin/permissions/general.error.cant-edit-this-permission') }}"></i>
                                        @endif
                                        ...
                                        @if ( $perm->isDeletable() )
                                            <a href="{!! route('admin.permissions.confirm-delete', $perm->id) !!}"
                                        ...
                                        @else
                                            <i class="fa fa-trash-o text-muted"
                                               title="{{ trans('admin/permissions/general.error.cant-delete-perm-in-use') }}"></i>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
